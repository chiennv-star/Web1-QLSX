...
public class User {
    ...
    public enum Role { ADMIN, TKSX, TPSX, QUAN_DOC, NHAN_VIEN, NHAN_VIEN_PCPL1, NHAN_VIEN_PCPL2, NHAN_VIEN_PCPL3, NHAN_VIEN_BBC1, NHAN_VIEN_DG, ADMIN_PC, ADMIN_BBC1, ADMIN_PL, ADMIN_DG, ADMIN_KH, ADMIN_PCPL1, ADMIN_PCPL2, ADMIN_PCPL3, HCNS, KE_TOAN, MAN_HINH }
