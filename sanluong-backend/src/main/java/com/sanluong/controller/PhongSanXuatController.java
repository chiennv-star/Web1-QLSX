...
@RestController
@RequestMapping("/api/phong-san-xuat")
public class PhongSanXuatController {

    private final PhongSanXuatRepository repo;

    public PhongSanXuatController(PhongSanXuatRepository repo) {
        this.repo = repo;
    }

    @GetMapping
    public ResponseEntity<List<PhongSanXuat>> getAll() {
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        PhongSanXuat p = repo.findById(id)
