      ...
      >
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          ...
          <Form.Item label="SL Trung bình" name="slTrungBinh"
            ...
            <InputNumber min={0} max={999999999} precision={3} step={0.001} style={{ width: '100%' }} placeholder="Mặc định: 1000" />
          </Form.Item>

          <Row gutter={16}>
            <Col span={8}>
              <Form.Item label="Năng suất PC" name="nangSuatPc">
                <InputNumber min={0} max={999999999} precision={3} step={0.001} style={{ width: '100%' }} placeholder="PC" />
              </Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item label="Năng suất PL" name="nangSuatPl">
                <InputNumber min={0} max={999999999} precision={3} step={0.001} style={{ width: '100%' }} placeholder="PL" />
              </Form.Item>
            </Col>
            <Col span={8}>
              <Form.Item label="Năng suất BBC1" name="nangSuatBbc1">
                <InputNumber min={0} max={999999999} precision={3} step={0.001} style={{ width: '100%' }} placeholder="BBC1" />
              </Form.Item>
            </Col>
          </Row>
