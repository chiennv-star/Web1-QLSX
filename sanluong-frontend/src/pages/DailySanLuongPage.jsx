...
function DailySummaryPanel({ data, refDate: refDateProp }) {
  ...
  const th = {
    ...
    padding: '7px 8px', border: '1px solid #00FF00',
  ...
  const secHead = {
    ...
    borderBottom: '2px solid #00FF00', letterSpacing: '0.04em',
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ margin: '8px 0 4px', border: '2px solid #00FF00', borderRadius: 8, overflow: 'hidden', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.12)' }}
      >
        {/* Header */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2.5fr 1fr', background: '#00CCCC', padding: '8px 16px', alignItems: 'center', borderBottom: '2px solid #00FF00' }}>
        ...
        <div className="dsp-body" style={{ display: 'grid', gridTemplateColumns: '220px 1fr 220px' }}>
          ...
          <div style={{ borderRight: '2px solid #00FF00' }}>
            ...
            <div className="dsp-sec-head" style={{ ...secHead, borderTop: '2px solid #00FF00' }}>TỔNG SẢN LƯỢNG THÁNG</div>
            {SUMMARY_DEPTS.map(d => (
              <div key={d.key} className="dsp-dept-row" style={deptRow}>
                <span style={{ fontWeight: 700, color: '#1e3a5f', fontSize: FS }}>{d.label}</span>
          ...
          {/* MIDDLE */}
          <div style={{ borderRight: '2px solid #00FF00', display: 'flex', flexDirection: 'column' }}>
          ...
          <div>
            ...
            <div className="dsp-sec-head" style={{ ...secHead, borderTop: '2px solid #00FF00' }}>HSCV {ref.subtract(1,'day').format('DD/MM')}</div>
            {SUMMARY_DEPTS.map(d => {
