...
function DailySummaryPanel({ data, refDate: refDateProp }) {
  ...
  const th = {
    ...
    padding: '7px 8px', border: '1px solid #FFFFFF',
  ...
  const secHead = {
    ...
    borderBottom: '2px solid #FFFFFF', letterSpacing: '0.04em',
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ margin: '8px 0 4px', border: '2px solid #FFFFFF', borderRadius: 8, overflow: 'hidden', background: '#fff', boxShadow: '0 2px 12px rgba(0,0,0,0.12)' }}
      >
        {/* Header */}
        ...
        <div className="dsp-body" style={{ display: 'grid', gridTemplateColumns: '220px 1fr 220px' }}>
          ...
          {/* MIDDLE */}
          <div style={{ borderRight: '2px solid #FFFFFF', display: 'flex', flexDirection: 'column' }}>
