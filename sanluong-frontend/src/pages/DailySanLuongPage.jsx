  ...
  const columns = [
    {
      ...
      onHeaderCell: () => ({ style: { background: '#FFCC99', color: '#1e3a5f', fontSize: 11 } }),
      render: v => (
    ...
    ...STAGES.map(s => ({
      ...
      key: s.key,
      align: 'center',
      onHeaderCell: () => ({ style: { background: '#FFCC99', color: '#1e3a5f', textAlign: 'center', borderLeft: '2px solid rgba(0,0,0,0.08)' } }),
      children: [
        {
          title: 'SL',
          key: `${s.key}_sl`,
          width: 95, align: 'right',
          onHeaderCell: () => ({ style: { background: '#FFCC99', color: '#1e3a5f', fontSize: 10 } }),
          render: (_, r) => {
