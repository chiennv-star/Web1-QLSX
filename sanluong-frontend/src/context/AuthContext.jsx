...
export function AuthProvider({ children }) {
  ...
  // Có thể đặt mục tiêu Nhập Kho: ADMIN, ADMIN_KH, TKSX (QUAN_DOC chỉ được xem, không được sửa)
  const canEditNhapKhoTarget = () => ['ADMIN', 'ADMIN_KH', 'TKSX'].includes(user?.role)
