    ...
    <Routes>
      ...
      <Route path="/" element={
        ...
        <Route path="cham-cong" element={
          <PrivateRoute allowedRoles={['ADMIN', 'KE_TOAN', 'HCNS', 'QUAN_DOC', 'TPSX', 'ADMIN_PCPL1', 'ADMIN_PCPL2', 'ADMIN_PCPL3', 'ADMIN_BBC1', 'ADMIN_DG', 'ADMIN_PC', 'ADMIN_PL']}>
            <ChamCongPage />
          </PrivateRoute>
        } />
        ...
        <Route path="phan-tich-ke-hoach" element={<PhanTichKeHoachPage />} />
